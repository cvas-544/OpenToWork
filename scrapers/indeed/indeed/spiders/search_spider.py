...
class IndeedSearchSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # Accept -a keyword=... -a location=... from command line, fall back to defaults
        keyword_list = [self.keyword] if hasattr(self, 'keyword') else ['software engineer']
        location_list = [self.location] if hasattr(self, 'location') else ['Germany']
